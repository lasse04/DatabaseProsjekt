...
def formater_seter(seter: list):
    
    formaterte_seter = [(int(sete[:-1]), sete[-1]) for sete in seter]
    formaterte_seter.sort()
    formaterte_seter = [f"{sete[0]}{sete[1]}" for sete in formaterte_seter]

    return formaterte_seter
